        ...
        {featured.map((project, i) => (
          <Reveal key={project.name} delay={i * 0.08}>
            <article
              ...
              className="group flex h-full cursor-pointer flex-col rounded-2xl border border-zinc-200 bg-white p-6 transition-all hover:-translate-y-0.5 hover:border-indigo-300 hover:shadow-lg sm:p-7 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-indigo-700/60 dark:hover:shadow-indigo-950/40"
            >
