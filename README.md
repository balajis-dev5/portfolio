...
1. Identity values are **already filled**: GitHub `balajis-dev5`, LinkedIn `linkedin.com/in/balaji-s-72245b244`, URL `https://balajis-dev.vercel.app`, company `RSoft Technologies`. If any of these ends up different (e.g. username taken), search-replace the old value across the repo.
