...
1. Identity values are **already filled**: GitHub `balajis-dev`, LinkedIn `linkedin.com/in/balaji-s-dev`, URL `https://balajis-dev.vercel.app`, company `RSoft Technologies`. If any of these ends up different (e.g. username taken), search-replace the old value across the repo.
